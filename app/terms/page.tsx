          ...
          >
            <section className="space-y-4">
              ...
              <p className="text-foreground/70">
                By accessing and using the Calapan City Government System website, you accept and agree to be bound by
            ...
            <section className="space-y-4">
              ...
              <p className="text-foreground/70">
                ...
                Calapan City Government System for personal, non-commercial transitory viewing only. This is the grant
            ...
            <section className="space-y-4">
              ...
              <p className="text-foreground/70">
                The materials on Calapan City Government System are provided on an 'as is' basis. Calapan City
            ...
            <section className="space-y-4">
              ...
              <p className="text-foreground/70">
                In no event shall Calapan City Government or its suppliers be liable for any damages (including, without
                limitation, damages for loss of data or profit, or due to business interruption) arising out of the use
                or inability to use the materials on Calapan City Government's website.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-foreground/70">
                The materials appearing on Calapan City Government's website could include technical, typographical, or
                photographic errors. Calapan City Government does not warrant that any of the materials on its website
