 ...
 * A reusable bottom navigation bar for citizen-facing pages
 * 
 ...
 * 
 * <CitizenBottomNav activeTab={activeTab} onTabChange={setActiveTab} />
 */
export default function CitizenBottomNav({ activeTab, onTabChange }: CitizenBottomNavProps) {
  const navItems = [
