...
const announcements = [
  ...
  },
  {
    ...
    excerpt: "Join us for the Annual Calapan City Festival this weekend!",
    content:
      "Join us for the Annual Calapan City Festival this weekend! Enjoy food, music, and community activities for the whole family.",
    category: "Event",
    date: "Nov 11, 2024",
    featured: false,
  },
    ...
    <main className="min-h-screen flex flex-col">
      ...
      <section className="bg-gradient-to-br from-orange-600 to-emerald-600 text-white py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          >
            Stay informed with the most recent updates and important notices from Calapan City Government.
          </motion.p>
        </div>
      </section>
