  ...
  const taxGuides = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          content: "Learn about property tax assessment, payment procedures, and available discounts in Calapan City.",
          fullContent: (
            <div className="space-y-4">
              <p className="text-sm text-gray-600">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    RPT is a local tax imposed on real property (land, buildings, machinery) based on its assessed value. The tax rate in Calapan City is determined by local ordinance.
                  </p>
                </div>
                <div>
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">Tax Rates in Calapan City</h4>
                  <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-2">
                    Calapan City offers installment plans for taxpayers with delinquent accounts:
                  </p>
                  <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
        ...
        },
        {
          ...
          content: "Explore available tax incentives for businesses in Calapan City.",
          fullContent: (
            <div className="space-y-4">
              <p className="text-sm text-gray-600">
                Calapan City offers various tax incentives to encourage business development and job creation.
              </p>
              <div className="space-y-3">
                <div>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
                    <li>Registered business in Calapan City</li>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="space-y-1 text-sm">
                  ...
                  <p className="text-gray-700"><strong>Contact:</strong> (043) 288-7777 | tax@calapancity.gov.ph</p>
                </div>
              </div>
            </div>
          </CardContent>
