  ...
  try {
    ...
    try {
      ...
      await transporter.sendMail({
        from: `"Calapan City Government" <${process.env.SMTP_FROM}>`,
        to: recipientEmail,
        ...
        html: `
          ...
          <body>
            <div class="container">
              <div class="header">
                <h2 style="margin: 0;">Calapan City Government</h2>
                <p style="margin: 5px 0 0 0; opacity: 0.9;">Response to Your Inquiry</p>
              </div>
              <div class="content">
                <p>Dear ${recipientName},</p>
                <p>Thank you for contacting Calapan City Government. We have reviewed your message regarding: <strong>${originalSubject}</strong></p>
                ...
                <p>Best regards,<br>
                <strong>Calapan City Government</strong></p>
              </div>
              <div class="footer">
                <p>This is an automated response from Calapan City Government.<br>
                Please do not reply directly to this email.</p>
                <p>© ${new Date().getFullYear()} Calapan City Government. All rights reserved.</p>
              </div>
            </div>
          </body>
          </html>
        `,
        text: `Dear ${recipientName},\n\nThank you for contacting Calapan City Government. We have reviewed your message regarding: ${originalSubject}\n\nOur Response:\n${message}\n\nIf you have any further questions or concerns, please don't hesitate to reach out to us.\n\nBest regards,\nCalapan City Government`,
      })
