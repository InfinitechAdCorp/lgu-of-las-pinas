          ...
          >
            <section className="space-y-4">
              ...
              <p className="text-foreground/70">
                Calapan City Government ("we" or "us" or "our") operates the website. This page informs you of our
            ...
            <section className="space-y-4">
              ...
              <p className="text-foreground/70">
                Calapan City Government uses the collected data for various purposes:
              </p>
              <ul className="list-disc list-inside text-foreground/70 space-y-2 pl-4">
